...
class Model(object):
    ...
    def compute_loss_derivative(self, output_activations, expanded_target_batch):
        ...
        ###########################   YOUR CODE HERE  ##############################
        ld = output_activations - expanded_target_batch
        return ld
    ...
    def back_propagate(self, input_batch, activations, loss_derivative):
        ...
        ###########################   YOUR CODE HERE  ##############################
        embed_to_hid_weights_grad = np.matmul(hid_deriv.transpose(), activations.embedding_layer)
        hid_to_output_weights_grad = np.matmul(loss_derivative.transpose(), activations.hidden_layer)
