...
def part_3():
    ...
    print("--------q1--------")
    samples = ['government of united', 'city of new', 'life in the', 'we have long']
    for s in samples:
        w1, w2, w3 = s.split()[0:3]
        print("Predict " + s)
        language_model.find_occurrences(w1, w2, w3)
    ...
    print()
    print(model.word_distance('this', 'that'))
    print(model.word_distance('this', 'come'))
